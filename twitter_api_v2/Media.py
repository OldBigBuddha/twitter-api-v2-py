...
class Media:
    def __init__(self, data: dict) -> None:
        ...
        self.duration_ms: Optional[int] = get_additional_field(
            data, Field.DURATION_MS.value, int
        )
        self.preview_image_url: Optional[str] = get_additional_field(
            data, Field.PREVIEW_IMAGE_URL.value
        )
